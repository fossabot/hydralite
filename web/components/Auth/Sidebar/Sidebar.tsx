  ...
  return (
    <Link href={`/projects/${props.title}`}>
      <div className="mb-3 md:ml-0 ml-5 md:h-10 md:w-10 lg:h-12 lg:w-12 relative has-tooltip">
        <Image
          src={props.img}
          className="rounded_box duration-200 cursor-pointer"
          alt=""
          width="50em"
          height="50em"
        />
...
export default function Sidebar() {
  return (
    <div className="h-full w-[5rem] flex flex-col items-center pt-16 select-none font-montserrat">
      ...
      />
      <div className="md:w-10 md:h-10 md:ml-0 lg:w-12 lg:h-12 ml-5 my-2 rounded_box flex items-center justify-center bg-iris-10 dark:bg-dark-bgMuted1 has-tooltip cursor-pointer">
        <PlusIconSolid className="w-[60%] fill-current" />
        <span className="tooltip rounded absolute w-auto py-2 p-1 pr-2 truncate shadow-xl bg-iris-10 dark:bg-dark-bgMuted2 text-black dark:text-white font-montserrat font-montserrat font-semiboldrabold ml-44">
          New Project
        </span>
      </div>
    </div>
