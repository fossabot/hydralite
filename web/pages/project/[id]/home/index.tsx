...
const WelcomeWidget: React.FC<{
  ...
  return (
    <div className="flex items-center justify-between h-28 max-w-xl bg-white-selected rounded-10 m-2 cursor-pointer select-none">
      <div className="flex items-center">
        <div
          className="grid place-items-center rounded-full h-14 w-14 mx-3"
          style={{ backgroundColor: color }}
        >
          <div className="h-7 w-7">{Icon}</div>
        </div>
        <div
          className={`flex flex-col justify-between items-start box-border py-1 w-96 ${contentClassName}`}
        >
