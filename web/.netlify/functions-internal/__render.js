	...
	"../node_modules/@sveltejs/kit/dist/install-fetch.js"() {
		...
		Blob = class {
			constructor(blobParts = [], options2 = {}) {
				...
				const type =
					options2.type === void 0
						? ""
						: String(options2.type).toLowerCase();
				wm.set(this, {
					type: /[^\u0020-\u007E]/.test(type) ? "" : type,
					size,
					parts,
...
var require_free_solid_svg_icons = __commonJS({
	"../node_modules/@fortawesome/free-solid-svg-icons/index.js"(
		...
		(function (global, factory) {
			...
			exports2.faAmericanSignLanguageInterpreting =
				faAmericanSignLanguageInterpreting;
...
var require_normalizeHeaderName = __commonJS({
	"node_modules/axios/lib/helpers/normalizeHeaderName.js"(exports, module2) {
		...
		("use strict");
		var utils = require_utils();
		module2.exports = function normalizeHeaderName(
			headers,
			normalizedName
		) {
		...
		function setup(env) {
			...
			function selectColor(namespace) {
				...
				return createDebug.colors[
					Math.abs(hash2) % createDebug.colors.length
				];
			}
	...
	"../node_modules/debug/src/node.js"(exports, module2) {
		...
		try {
			...
			if (
				...
				exports.colors = [
					...
					98, 99, 112, 113, 128, 129, 134, 135, 148, 149, 160, 161,
					162, 163, 164, 165, 166, 167, 168, 169, 170, 171, 172, 173,
					178, 179, 184, 185, 196, 197, 198, 199, 200, 201, 202, 203,
		...
		function formatArgs(args) {
			...
			if (useColors2) {
				...
				args.push(
					colorCode + "m+" + module2.exports.humanize(this.diff) + "[0m"
				);
			} else {
		...
		RedirectableRequest.prototype._processResponse = function (response) {
			...
			if (
				...
				try {
					...
					var error2 = new RedirectionError(
					...
					function handleResponse(res) {
						...
						if (config.responseType === "stream") {
							...
							stream.on("error", function handleStreamError(err) {
								if (req.aborted) return;
								reject(
									enhanceError(err, config, null, lastRequest)
								);
							});
		...
		function assertOptions(options2, schema, allowUnknown) {
			...
			while (i-- > 0) {
				...
				if (validator) {
					...
					var result =
						value === void 0 || validator(value, opt, options2);
					if (result !== true) {
						throw new TypeError(
...
function init(settings = default_settings) {
	...
	options = {
		...
		entry: {
			...
			css: [
				assets + "/_app/assets/start-d5b4de3e.css",
				assets + "/_app/assets/vendor-8992211a.css",
			],
			js: [
				assets + "/_app/start-be264233.js",
				assets + "/_app/chunks/vendor-96070f95.js",
			],
		},
		fetched: void 0,
		floc: false,
...
var manifest = {
	assets: [
		{ file: "favicon.png", size: 24641, type: "image/png" },
		{ file: "logo/logo.png", size: 24641, type: "image/png" },
		{ file: "logo/logo.svg", size: 5441, type: "image/svg+xml" },
		{ file: "robots.txt", size: 70, type: "text/plain" },
	],
...
var metadata_lookup = {
	"src/routes/__layout.svelte": {
		entry: "pages/__layout.svelte-837c4826.js",
		css: [
			"assets/pages/__layout.svelte-710e5962.css",
			"assets/vendor-8992211a.css",
			"assets/Toast.svelte_svelte&type=style&lang-77d127c2.css",
		],
		js: [
			"pages/__layout.svelte-837c4826.js",
			"chunks/vendor-96070f95.js",
			"chunks/Toast.svelte_svelte&type=style&lang-4fc86e7f.js",
		],
		styles: [],
	},
	".svelte-kit/build/components/error.svelte": {
		entry: "error.svelte-4f1098ad.js",
		css: ["assets/vendor-8992211a.css"],
		js: ["error.svelte-4f1098ad.js", "chunks/vendor-96070f95.js"],
		styles: [],
	},
	"src/routes/index.svelte": {
		entry: "pages/index.svelte-c7022303.js",
		css: [
			"assets/pages/index.svelte-f30cb46d.css",
			"assets/vendor-8992211a.css",
			"assets/Toast.svelte_svelte&type=style&lang-77d127c2.css",
		],
		js: [
			"pages/index.svelte-c7022303.js",
			"chunks/vendor-96070f95.js",
			"chunks/Toast.svelte_svelte&type=style&lang-4fc86e7f.js",
		],
		styles: [],
...
<div class="${"notifications svelte-4nmjjb"}">${each(
		$notifications,
		(notification) => `<div class="${"toast svelte-4nmjjb"}" style="${
			"background: " + escape(themes[notification.type]) + ";"
		}"><div class="${"content svelte-4nmjjb"}">${escape(
...
var Fa = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	if (
		$$props.translateX === void 0 &&
		$$bindings.translateX &&
		translateX !== void 0
	)
		$$bindings.translateX(translateX);
	if (
		$$props.translateY === void 0 &&
		$$bindings.translateY &&
		translateY !== void 0
	)
	...
	if (
		$$props.primaryColor === void 0 &&
		$$bindings.primaryColor &&
		primaryColor !== void 0
	)
		$$bindings.primaryColor(primaryColor);
	if (
		$$props.secondaryColor === void 0 &&
		$$bindings.secondaryColor &&
		secondaryColor !== void 0
	)
		$$bindings.secondaryColor(secondaryColor);
	if (
		$$props.primaryOpacity === void 0 &&
		$$bindings.primaryOpacity &&
		primaryOpacity !== void 0
	)
		$$bindings.primaryOpacity(primaryOpacity);
	if (
		$$props.secondaryOpacity === void 0 &&
		$$bindings.secondaryOpacity &&
		secondaryOpacity !== void 0
	)
		$$bindings.secondaryOpacity(secondaryOpacity);
	if (
		$$props.swapOpacity === void 0 &&
		$$bindings.swapOpacity &&
		swapOpacity !== void 0
	)
	...
	return `${
		i[4]
			? `<svg${add_attribute("id", id2, 0)} class="${
					escape(null_to_empty(c)) + " svelte-1cj2gr0"
			  }"${add_attribute("style", s2, 0)}${add_attribute(
					"viewBox",
					`0 0 ${i[0]} ${i[1]}`,
					0
			  )} aria-hidden="${"true"}" role="${"img"}" xmlns="${"http://www.w3.org/2000/svg"}"><g${add_attribute(
					"transform",
					...
					typeof i[4] == "string"
						? `<path${add_attribute("d", i[4], 0)}${add_attribute(
								"fill",
          ...
          <path${add_attribute("d", i[4][1], 0)}${add_attribute(
								"fill",
...
var Skeleton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<div class="${"w-screen h-screen bg-white dark:bg-dark-bg"}"><div class="${"w-[calc(100vw-24px)] h-[50px] flex items-center justify-between mx-3"}"><h1 class="${"font-montserrat font-extrabold text-xl text-black dark:text-white"}">HYDRALITE
		...
		<div class="${"flex bg-iris-10 dark:bg-dark-bgMuted1 w-44 h-10 rounded-lg items-center justify-between px-4 gap-2"}"><img${add_attribute(
		"src",
		$user.profilePicture,
		0
	)} width="${"20%"}" class="${"rounded-xl"}" alt="${"Profile pic"}">
			<span class="${"text-sm text-black dark:text-white"}">${escape(
		(_a = $user.name) != null ? _a : ""
	)}</span>
			<div class="${""}">${validate_component(Fa, "Fa").$$render(
		$$result,
		{
...
var Loading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `${
		...
		}<link rel="${"shortcut icon"}" href="${"/logo/logo.svg"}" data-svelte="svelte-17icovz">`),
		"")
	}
...
var ProtectedRoute = create_ssr_component(
	($$result, $$props, $$bindings, slots) => {
		...
		return `${validate_component(Toast, "Toaster").$$render(
			$$result,
			{},
			{},
			{}
...
${
	(($$result.head += `${
		(($$result.title = `<title>Hydralite</title>`), "")
	}<link rel="${"shortcut icon"}" href="${"/logo/logo.svg"}" data-svelte="svelte-l10m3f">`),
	"")
}
