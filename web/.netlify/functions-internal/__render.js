...
var require_free_solid_svg_icons = __commonJS({
  "../node_modules/@fortawesome/free-solid-svg-icons/index.js"(exports, module2) {
    ...
    (function(global, factory) {
      typeof exports === "object" && typeof module2 !== "undefined" ? factory(exports) : typeof define === "function" && define.amd ? define(["exports"], factory) : factory(global["free-solid-svg-icons"] = {});
      ...
      exports2.faChevronDown = faChevronDown2;
      ...
      exports2.faPaperclip = faPaperclip;
      ...
      exports2.faSignOutAlt = faSignOutAlt;
      ...
      exports2.faTachometerAlt = faTachometerAlt;
...
function init(settings = default_settings) {
  ...
  options = {
    ...
    dev: false,
    entry: {
      file: assets + "/_app/start-be264233.js",
      css: [assets + "/_app/assets/start-d5b4de3e.css", assets + "/_app/assets/vendor-8992211a.css"],
      js: [assets + "/_app/start-be264233.js", assets + "/_app/chunks/vendor-96070f95.js"]
    },
    fetched: void 0,
    floc: false,
...
var empty = () => ({});
var manifest = {
  assets: [{ "file": "favicon.png", "size": 24641, "type": "image/png" }, { "file": "logo/logo.png", "size": 24641, "type": "image/png" }, { "file": "logo/logo.svg", "size": 5441, "type": "image/svg+xml" }, { "file": "robots.txt", "size": 70, "type": "text/plain" }],
...
var metadata_lookup = { "src/routes/__layout.svelte": { "entry": "pages/__layout.svelte-837c4826.js", "css": ["assets/pages/__layout.svelte-710e5962.css", "assets/vendor-8992211a.css", "assets/Toast.svelte_svelte&type=style&lang-77d127c2.css"], "js": ["pages/__layout.svelte-837c4826.js", "chunks/vendor-96070f95.js", "chunks/Toast.svelte_svelte&type=style&lang-4fc86e7f.js"], "styles": [] }, ".svelte-kit/build/components/error.svelte": { "entry": "error.svelte-4f1098ad.js", "css": ["assets/vendor-8992211a.css"], "js": ["error.svelte-4f1098ad.js", "chunks/vendor-96070f95.js"], "styles": [] }, "src/routes/index.svelte": { "entry": "pages/index.svelte-c7022303.js", "css": ["assets/pages/index.svelte-f30cb46d.css", "assets/vendor-8992211a.css", "assets/Toast.svelte_svelte&type=style&lang-77d127c2.css"], "js": ["pages/index.svelte-c7022303.js", "chunks/vendor-96070f95.js", "chunks/Toast.svelte_svelte&type=style&lang-4fc86e7f.js"], "styles": [] } };
...
var css$3 = {
  code: ".notifications.svelte-4nmjjb{position:fixed;top:10px;left:0;right:0;margin:0 auto;padding:0;border-radius:10px;z-index:9999;display:flex;flex-direction:column;justify-content:flex-start;align-items:center;pointer-events:none}.toast.svelte-4nmjjb{flex:0 0 auto;margin-bottom:10px;border-radius:10px}.content.svelte-4nmjjb{padding:10px;display:block;color:white;font-weight:500}",
  map: '{"version":3,"file":"Toast.svelte","sources":["Toast.svelte"],"sourcesContent":["<style>\\r\\n.notifications {\\r\\n\\tposition: fixed;\\r\\n\\ttop: 10px;\\r\\n\\tleft: 0;\\r\\n\\tright: 0;\\r\\n\\tmargin: 0 auto;\\r\\n\\tpadding: 0;\\r\\n\\tborder-radius: 10px;\\r\\n\\tz-index: 9999;\\r\\n\\tdisplay: flex;\\r\\n\\tflex-direction: column;\\r\\n\\tjustify-content: flex-start;\\r\\n\\talign-items: center;\\r\\n\\tpointer-events: none;\\r\\n}\\r\\n\\r\\n.toast {\\r\\n\\tflex: 0 0 auto;\\r\\n\\tmargin-bottom: 10px;\\r\\n\\tborder-radius: 10px;\\r\\n}\\r\\n\\r\\n.content {\\r\\n\\tpadding: 10px;\\r\\n\\tdisplay: block;\\r\\n\\tcolor: white;\\r\\n\\tfont-weight: 500;\\r\\n}\\r\\n</style>\\r\\n\\r\\n<!-- This code rightfully belongs to https://svelte.dev/repl/2254c3b9b9ba4eeda05d81d2816f6276?version=3.32.2 -->\\r\\n<script>\\r\\n// @ts-nocheck\\r\\n\\r\\nimport { flip } from \\"svelte/animate\\";\\r\\nimport { fly } from \\"svelte/transition\\";\\r\\nimport { notifications } from \\"./notifications\\";\\r\\n\\r\\nexport let themes = {\\r\\n\\tdanger: \\"#E26D69\\",\\r\\n\\tsuccess: \\"#84C991\\",\\r\\n\\twarning: \\"#f0ad4e\\",\\r\\n\\tinfo: \\"#5bc0de\\",\\r\\n\\tdefault: \\"#aaaaaa\\",\\r\\n};\\r\\n<\/script>\\r\\n\\r\\n<div class=\\"notifications\\">\\r\\n\\t{#each $notifications as notification (notification.id)}\\r\\n\\t\\t<div\\r\\n\\t\\t\\tanimate:flip\\r\\n\\t\\t\\tclass=\\"toast\\"\\r\\n\\t\\t\\tstyle=\\"background: {themes[notification.type]};\\"\\r\\n\\t\\t\\ttransition:fly=\\"{{ y: 30 }}\\">\\r\\n\\t\\t\\t<div class=\\"content\\">{notification.message}</div>\\r\\n\\t\\t\\t{#if notification.icon}<i class=\\"{notification.icon}\\"></i>{/if}\\r\\n\\t\\t</div>\\r\\n\\t{/each}\\r\\n</div>\\r\\n"],"names":[],"mappings":"AACA,cAAc,cAAC,CAAC,AACf,QAAQ,CAAE,KAAK,CACf,GAAG,CAAE,IAAI,CACT,IAAI,CAAE,CAAC,CACP,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CAAC,IAAI,CACd,OAAO,CAAE,CAAC,CACV,aAAa,CAAE,IAAI,CACnB,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,IAAI,CACb,cAAc,CAAE,MAAM,CACtB,eAAe,CAAE,UAAU,CAC3B,WAAW,CAAE,MAAM,CACnB,cAAc,CAAE,IAAI,AACrB,CAAC,AAED,MAAM,cAAC,CAAC,AACP,IAAI,CAAE,CAAC,CAAC,CAAC,CAAC,IAAI,CACd,aAAa,CAAE,IAAI,CACnB,aAAa,CAAE,IAAI,AACpB,CAAC,AAED,QAAQ,cAAC,CAAC,AACT,OAAO,CAAE,IAAI,CACb,OAAO,CAAE,KAAK,CACd,KAAK,CAAE,KAAK,CACZ,WAAW,CAAE,GAAG,AACjB,CAAC"}'
};
...
<div class="${"notifications svelte-4nmjjb"}">${each($notifications, (notification) => `<div class="${"toast svelte-4nmjjb"}" style="${"background: " + escape(themes[notification.type]) + ";"}"><div class="${"content svelte-4nmjjb"}">${escape(notification.message)}</div>
			${notification.icon ? `<i class="${escape(null_to_empty(notification.icon)) + " svelte-4nmjjb"}"></i>` : ``}
		</div>`)}</div>`;
});
var css$2 = {
...
var Fa = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  transform = getTransform(scale, translateX, translateY, rotate, flip, 512);
  return `${i[4] ? `<svg${add_attribute("id", id2, 0)} class="${escape(null_to_empty(c)) + " svelte-1cj2gr0"}"${add_attribute("style", s2, 0)}${add_attribute("viewBox", `0 0 ${i[0]} ${i[1]}`, 0)} aria-hidden="${"true"}" role="${"img"}" xmlns="${"http://www.w3.org/2000/svg"}"><g${add_attribute("transform", `translate(${i[0] / 2} ${i[1] / 2})`, 0)}${add_attribute("transform-origin", `${i[0] / 4} 0`, 0)}><g${add_attribute("transform", transform, 0)}>${typeof i[4] == "string" ? `<path${add_attribute("d", i[4], 0)}${add_attribute("fill", color || primaryColor || "currentColor", 0)}${add_attribute("transform", `translate(${i[0] / -2} ${i[1] / -2})`, 0)}></path>` : `<path${add_attribute("d", i[4][0], 0)}${add_attribute("fill", secondaryColor || color || "currentColor", 0)}${add_attribute("fill-opacity", swapOpacity != false ? primaryOpacity : secondaryOpacity, 0)}${add_attribute("transform", `translate(${i[0] / -2} ${i[1] / -2})`, 0)}></path>
...
var Skeleton = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  $$unsubscribe_user();
  return `<div class="${"w-screen h-screen bg-white dark:bg-dark-bg"}"><div class="${"w-[calc(100vw-24px)] h-[50px] flex items-center justify-between mx-3"}"><h1 class="${"font-montserrat font-extrabold text-xl text-black dark:text-white"}">HYDRALITE
		</h1>
		<div class="${"flex gap-4 font-bold text-xl text-black dark:text-white"}"><span>Discover</span>
			<span>Project</span>
			<span>Project Ideas</span></div>
		<div class="${"flex bg-iris-10 dark:bg-dark-bgMuted1 w-44 h-10 rounded-lg items-center justify-between px-4 gap-2"}"><img${add_attribute("src", $user.profilePicture, 0)} width="${"20%"}" class="${"rounded-xl"}" alt="${"Profile pic"}">
			<span class="${"text-sm text-black dark:text-white"}">${escape((_a = $user.name) != null ? _a : "")}</span>
			<div class="${""}">${validate_component(Fa, "Fa").$$render($$result, {
    icon: import_free_solid_svg_icons.faChevronDown,
    class: "text-black dark:text-white"
  }, {}, {})}</div></div></div>
	<div class="${"w-[50px] h-[calc(100vh-100px)] mt-[20px] flex items-center flex-col"}"><h1>asd</h1>
		<h1>asd</h1></div></div>`;
});
var css = {
  code: '.shim-blue.svelte-1xempks{position:relative;overflow:hidden;background-color:rgba(17, 24, 39)}.shim-blue.svelte-1xempks::after{position:absolute;top:0;right:0;bottom:0;left:0;transform:translateX(-100%);background-image:linear-gradient(\r\n		90deg,\r\n		rgba(93, 107, 255, 1) 0,\r\n		rgba(93, 107, 255, 0.9) 50%,\r\n		rgba(93, 107, 255, 0.8) 100%\r\n	);animation:svelte-1xempks-shimmer 3s ease-out infinite;content:""}@keyframes svelte-1xempks-shimmer{100%{transform:translateX(0%);opacity:0}}',
  map: '{"version":3,"file":"Loading.svelte","sources":["Loading.svelte"],"sourcesContent":["<style>\\r\\n.footer {\\r\\n\\tposition: fixed;\\r\\n\\tdisplay: flex;\\r\\n\\talign-items: center;\\r\\n\\tjustify-content: center;\\r\\n\\tbottom: 0;\\r\\n\\twidth: 100%;\\r\\n\\tcolor: white;\\r\\n\\ttext-align: center;\\r\\n\\tmargin: 20px;\\r\\n}\\r\\n.shim-blue {\\r\\n\\tposition: relative;\\r\\n\\toverflow: hidden;\\r\\n\\tbackground-color: rgba(17, 24, 39);\\r\\n}\\r\\n.shim-blue::after {\\r\\n\\tposition: absolute;\\r\\n\\ttop: 0;\\r\\n\\tright: 0;\\r\\n\\tbottom: 0;\\r\\n\\tleft: 0;\\r\\n\\ttransform: translateX(-100%);\\r\\n\\tbackground-image: linear-gradient(\\r\\n\\t\\t90deg,\\r\\n\\t\\trgba(93, 107, 255, 1) 0,\\r\\n\\t\\trgba(93, 107, 255, 0.9) 50%,\\r\\n\\t\\trgba(93, 107, 255, 0.8) 100%\\r\\n\\t);\\r\\n\\tanimation: shimmer 3s ease-out infinite;\\r\\n\\tcontent: \\"\\";\\r\\n}\\r\\n\\r\\n@keyframes shimmer {\\r\\n\\t100% {\\r\\n\\t\\ttransform: translateX(0%);\\r\\n\\t\\topacity: 0;\\r\\n\\t}\\r\\n}\\r\\n</style>\\r\\n\\r\\n<svelte:head>\\r\\n\\t<title>Hydralite | Loading</title>\\r\\n\\t<link rel=\\"shortcut icon\\" href=\\"/logo/logo.svg\\" />\\r\\n</svelte:head>\\r\\n<div\\r\\n\\tclass=\\"bg-white h-screen w-screen dark:bg-acrylic-70 flex items-center justify-center absolute flex-col dark:text-white text-black select-none\\">\\r\\n\\t<img\\r\\n\\t\\tsrc=\\"/logo/logo.svg\\"\\r\\n\\t\\talt=\\"Hydralite logo\\"\\r\\n\\t\\twidth=\\"8%\\"\\r\\n\\t\\tclass=\\"motion-safe:animate-pulse\\" />\\r\\n\\t<div class=\\"relative w-72 bg-transparent rounded mt-9\\">\\r\\n\\t\\t<div style=\\"width: 100%\\" class=\\"absolute top-0 h-2 rounded shim-blue\\">\\r\\n\\t\\t</div>\\r\\n\\t</div>\\r\\n\\t<!-- <div class=\\"footer\\">\\r\\n\\t\\t<h1 class=\\"text-3xl font-montserrat font-extrabold\\">HYDRALITE</h1>\\r\\n\\t</div> -->\\r\\n</div>\\r\\n"],"names":[],"mappings":"AAYA,UAAU,eAAC,CAAC,AACX,QAAQ,CAAE,QAAQ,CAClB,QAAQ,CAAE,MAAM,CAChB,gBAAgB,CAAE,KAAK,EAAE,CAAC,CAAC,EAAE,CAAC,CAAC,EAAE,CAAC,AACnC,CAAC,AACD,yBAAU,OAAO,AAAC,CAAC,AAClB,QAAQ,CAAE,QAAQ,CAClB,GAAG,CAAE,CAAC,CACN,KAAK,CAAE,CAAC,CACR,MAAM,CAAE,CAAC,CACT,IAAI,CAAE,CAAC,CACP,SAAS,CAAE,WAAW,KAAK,CAAC,CAC5B,gBAAgB,CAAE;EACjB,KAAK,CAAC;EACN,KAAK,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC,CAAC;EACxB,KAAK,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC;EAC5B,KAAK,EAAE,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,GAAG,CAAC,CAAC,IAAI;EAC5B,CACD,SAAS,CAAE,sBAAO,CAAC,EAAE,CAAC,QAAQ,CAAC,QAAQ,CACvC,OAAO,CAAE,EAAE,AACZ,CAAC,AAED,WAAW,sBAAQ,CAAC,AACnB,IAAI,AAAC,CAAC,AACL,SAAS,CAAE,WAAW,EAAE,CAAC,CACzB,OAAO,CAAE,CAAC,AACX,CAAC,AACF,CAAC"}'
};
var Loading = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  $$result.css.add(css);
  return `${$$result.head += `${$$result.title = `<title>Hydralite | Loading</title>`, ""}<link rel="${"shortcut icon"}" href="${"/logo/logo.svg"}" data-svelte="svelte-17icovz">`, ""}
<div class="${"bg-white h-screen w-screen dark:bg-acrylic-70 flex items-center justify-center absolute flex-col dark:text-white text-black select-none"}"><img src="${"/logo/logo.svg"}" alt="${"Hydralite logo"}" width="${"8%"}" class="${"motion-safe:animate-pulse"}">
	<div class="${"relative w-72 bg-transparent rounded mt-9"}"><div style="${"width: 100%"}" class="${"absolute top-0 h-2 rounded shim-blue svelte-1xempks"}"></div></div>
	</div>`;
});
var ProtectedRoute = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  ...
  return `${validate_component(Toast, "Toaster").$$render($$result, {}, {}, {})}

${$$result.head += `${$$result.title = `<title>Hydralite</title>`, ""}<link rel="${"shortcut icon"}" href="${"/logo/logo.svg"}" data-svelte="svelte-l10m3f">`, ""}
${`${validate_component(Loading, "Loading").$$render($$result, {}, {}, {})}`}`;
});
var prerender = true;
var Routes = create_ssr_component(($$result, $$props, $$bindings, slots) => {
  getContext("Auth");
  return `${validate_component(ProtectedRoute, "ProtectedRoute").$$render($$result, {}, {}, {
    default: () => `${validate_component(Skeleton, "Skeleton").$$render($$result, {}, {}, {})}`
  })}`;
});
